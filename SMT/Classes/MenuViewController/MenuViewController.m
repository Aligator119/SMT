...
- (id)initWithFrame:(CGRect)frame controller:(MenuViewController*)controller
{
...
{
    __weak MenuViewController *_revealVC;
    UIView *_view;
...
- (id)initWithRevealController:(MenuViewController*)revealVC containerView:(UIView*)view fromVC:(UIViewController*)fromVC
...
- (void)_dispatchSetFrontViewPosition:(FrontViewPosition)frontViewPosition animated:(BOOL)animated
{
    ...
    __weak MenuViewController *theSelf = self;
...
+ (UIViewController *)viewControllerWithRestorationIdentifierPath:(NSArray *)identifierComponents coder:(NSCoder*)coder
{
    ...
    if (sb)
    {
        vc = (MenuViewController*)[sb instantiateViewControllerWithIdentifier:@"MenuViewController"];
        vc.restorationIdentifier = [identifierComponents lastObject];
        vc.restorationClass = [MenuViewController class];
    }
    return vc;
}
...
- (MenuViewController*)revealViewController
{
    ...
    Class revealClass = [MenuViewController class];
...
- (void)perform
{
    ...
    MenuViewController *rvc = self.sourceViewController;
...
- (void)perform
{
    MenuViewController *rvc = [self.sourceViewController revealViewController];
    UIViewController *dvc = self.destinationViewController;
